...
<head>
    ...
    <script type="application/javascript"  language="javascript">
        ...
        function drop(ev, id) {
           ...
           alert(x+"  "+y);
            if(elementId == "not"){
                ctx4.drawImage(dropElement, 80, -15, 140, 160);
                canvas4Image = elementId;
            }

            else if(y < 500 && x<1250 && !isCanvasOneFilled){

                ctx.drawImage(dropElement, 59, -30, 180, 210);
                isCanvasOneFilled = true;
                canvas1Image = elementId;
            }
            else if(y < 500 && x>1250 && !isCanvasThreeFilled){
                ctx3.drawImage(dropElement, 45, -8, 180, 185);
                canvas3Image  = elementId;
                isCanvasThreeFilled = true;
            }
            else if(y > 500 && !isCanvasTwoFilled){
                //alert("ctx2");

                ctx2.drawImage(dropElement, 57, -33, 180, 210);
        ...
        function evaluate(){
            ...
            if((canvas1Image == "and") && (canvas2Image == "and2") && (canvas3Image == "or") && (canvas4Image == "not") && timer >0){
                isUserWin = true;
                showWinImg();
            }else if((canvas1Image == "and2") && (canvas2Image == "and") && (canvas3Image == "or") && (canvas4Image == "not") && timer >0){
                isUserWin = true;
                showWinImg();
            }else{
                isUserWin = false;
...
<ul>
    ...
    <li><a href="/instruction?level=3">Instructions</a></li>
...
<div id="container">
    <div id="leftCol">
        ...
        <div id="raw2">
            <img class="row2" id="and" class="playIcon" src="<c:url value="/images/and.svg" />" draggable="true" ondragstart="drag(event, this.id)" width="120px"/>
            <img class="row2" id="nand" class="playIcon" src="<c:url value="/images/nand.svg" />" draggable="true" ondragstart="drag(event, this.id)" width="120px"/>
            <img class="row2" id="nor" class="playIcon" src="<c:url value="/images/nor.svg" />" draggable="true" ondragstart="drag(event, this.id)" width="120px"/>
        </div>
        <div id="raw3">
            <img class="row3" id="or" class="playIcon" src="<c:url value="/images/or.svg" />" draggable="true" ondragstart="drag(event, this.id)" width="120px"/>
            <img class="row3" id="not" class="playIcon" src="<c:url value="/images/not.svg" />" draggable="true" ondragstart="drag(event, this.id)" width="120px"/>
            <img class="row3" id="and2" class="playIcon" src="<c:url value="/images/and.svg" />" draggable="true" ondragstart="drag(event, this.id)" width="120px"/>
        </div>

    </div>
    <div id="rightCol" ondrop="drop(event)" ondragover="allowDrop(event)">
        <img id="circuit1" src="<c:url value="/images/circuitn3.svg" />" />
        <canvas id="canvas1" ondrop="drop(event)" ondragover="allowDrop(event)" style="position:absolute; top:327px; left:1083px"></canvas>
        <canvas id="canvas2" ondrop="drop(event)" ondragover="allowDrop(event)" style="position:absolute; top:601px; left:1090px" ></canvas>
        <canvas id="canvas3" ondrop="drop(event)" ondragover="allowDrop(event)" style="position:absolute; top:444px; left:1319px"></canvas>
        <canvas id="canvas4" ondrop="drop(event)" ondragover="allowDrop(event)" style="position:absolute; top:637px; left:963px"></canvas>
        </canvas>
    </div>
</div>
</body>
